...
<?php
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		?><tr class="acf-field acf-field-setting-sub_fields" data-setting="repeater" data-name="sub_fields" style="display: flex; flex-wrap: wrap;">
			<td class="acf-label" style="flex: 0 0 100%; max-width: 100%;">
				<label><?php _e("Sub Fields",'acf'); ?></label>
				<p class="description"></p>		
			</td>
			<td class="acf-input" style="flex: 0 0 100%; max-width: 100%;">
				<?php 
